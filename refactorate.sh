...
echo "🎨 Corrigindo motor de Regex do Vimscript para Highlights..."
...
echo "✅ Highlight corrigido! Feche o buffer de chat atual e abra de novo para ver as cores atualizadas."
