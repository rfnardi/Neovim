...
echo "🛠️ Corrigindo a injeção de Parser e a UI de Highlights..."

# 1. Atualizando o ui/highlights.lua para colorir "## User >>" e afins
cat << 'EOF' > "$PLUGIN_DIR/ui/highlights.lua"
local api = vim.api
local M = {}
...
# 2. Corrigindo o init.lua para repassar a linha correta da IA sem adivinhação
...
echo "✅ Correção Aplicada! Pode usar a compressão novamente, o arquivo será sobreescrito com sucesso!"
